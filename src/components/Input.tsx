            ...
            {options ? (
                <div className="relative" ref={dropdownRef}>
                    <button
                        ...
                        className="w-full px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent hover:border-gray-300 transition-colors outline-none text-left flex items-center gap-2"
                    >
                        {selectedOption?.flag && (
                        ...
                        <div className="absolute z-10 w-full mt-1 bg-white border border-gray-200 rounded-lg shadow-lg max-h-60 overflow-auto">
                            {options.map(option => (
                                <button
                                    ...
                                    className="w-full px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base text-left hover:bg-gray-50 flex items-center gap-2"
                                >
                                    {option.flag && (
